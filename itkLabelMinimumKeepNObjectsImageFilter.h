/*=========================================================================
  ...
  Module:    $RCSfile: itkLabelMinimumKeepNObjectsImageFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkLabelMinimumKeepNObjectsImageFilter_h
#define __itkLabelMinimumKeepNObjectsImageFilter_h
...
class ITK_EXPORT LabelMinimumKeepNObjectsImageFilter : 
    public LabelAttributeKeepNObjectsImageFilter<TInputImage,
      ...
      typename Functor::MinimumLabelObjectAccessor< StatisticsLabelObject< unsigned long, TInputImage::ImageDimension > > >
{
public:
  /** Standard class typedefs. */
  typedef LabelMinimumKeepNObjectsImageFilter Self;
  ...
  itkTypeMacro(LabelMinimumKeepNObjectsImageFilter, 
...
protected:
  LabelMinimumKeepNObjectsImageFilter() {};
  ~LabelMinimumKeepNObjectsImageFilter() {};
...
private:
  LabelMinimumKeepNObjectsImageFilter(const Self&); //purposely not implemented
