/*=========================================================================
  ...
  Module:    $RCSfile: itkLabelSumKeepNObjectsImageFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkLabelSumKeepNObjectsImageFilter_h
#define __itkLabelSumKeepNObjectsImageFilter_h
...
class ITK_EXPORT LabelSumKeepNObjectsImageFilter : 
    public LabelAttributeKeepNObjectsImageFilter<TInputImage,
      ...
      typename Functor::SumLabelObjectAccessor< StatisticsLabelObject< unsigned long, TInputImage::ImageDimension > > >
{
public:
  /** Standard class typedefs. */
  typedef LabelSumKeepNObjectsImageFilter Self;
  ...
  itkTypeMacro(LabelSumKeepNObjectsImageFilter, 
...
protected:
  LabelSumKeepNObjectsImageFilter() {};
  ~LabelSumKeepNObjectsImageFilter() {};
...
private:
  LabelSumKeepNObjectsImageFilter(const Self&); //purposely not implemented
