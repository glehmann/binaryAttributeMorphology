/*=========================================================================
  ...
  Module:    $RCSfile: itkBinaryPhysicalSizeOpeningImageFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkBinaryPhysicalSizeOpeningImageFilter_h
#define __itkBinaryPhysicalSizeOpeningImageFilter_h
...
/** \class BinaryPhysicalSizeOpeningImageFilter
 * \brief Identify local maxima whose height above the baseline is greater than h.
 *
 * \ingroup ImageEnhancement  MathematicalMorphologyImageFilters
 */
template<class TInputImage>
class ITK_EXPORT BinaryPhysicalSizeOpeningImageFilter : 
...
public:
  ...
  typedef BinaryPhysicalSizeOpeningImageFilter Self;
  ...
  itkTypeMacro(BinaryPhysicalSizeOpeningImageFilter, 
...
protected:
  BinaryPhysicalSizeOpeningImageFilter() {};
  ~BinaryPhysicalSizeOpeningImageFilter() {};

private:
  BinaryPhysicalSizeOpeningImageFilter(const Self&); //purposely not implemented
