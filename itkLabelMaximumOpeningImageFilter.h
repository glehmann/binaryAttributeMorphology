/*=========================================================================
  ...
  Module:    $RCSfile: itkLabelMaximumOpeningImageFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkLabelMaximumOpeningImageFilter_h
#define __itkLabelMaximumOpeningImageFilter_h
...
public:
  ...
  typedef LabelMaximumOpeningImageFilter Self;
  ...
  itkTypeMacro(LabelMaximumOpeningImageFilter, 
...
protected:
  LabelMaximumOpeningImageFilter() {};
  ~LabelMaximumOpeningImageFilter() {};
...
private:
  LabelMaximumOpeningImageFilter(const Self&); //purposely not implemented
