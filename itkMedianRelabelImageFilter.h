/*=========================================================================
  ...
  Module:    $RCSfile: itkMedianRelabelImageFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkMedianRelabelImageFilter_h
#define __itkMedianRelabelImageFilter_h
...
public:
  ...
  typedef MedianRelabelImageFilter Self;
  ...
  itkTypeMacro(MedianRelabelImageFilter, 
...
private:
  MedianRelabelImageFilter(const Self&); //purposely not implemented
