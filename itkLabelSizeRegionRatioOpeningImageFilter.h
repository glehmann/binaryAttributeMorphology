/*=========================================================================
  ...
  Module:    $RCSfile: itkLabelSizeRegionRatioOpeningImageFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkLabelSizeRegionRatioOpeningImageFilter_h
#define __itkLabelSizeRegionRatioOpeningImageFilter_h
...
/** \class LabelSizeRegionRatioOpeningImageFilter
 * \brief Identify local maxima whose height above the baseline is greater than h.
 *
 * \ingroup ImageEnhancement  MathematicalMorphologyImageFilters
 */
template<class TInputImage>
class ITK_EXPORT LabelSizeRegionRatioOpeningImageFilter : 
...
public:
  ...
  typedef LabelSizeRegionRatioOpeningImageFilter Self;
  ...
  itkTypeMacro(LabelSizeRegionRatioOpeningImageFilter, 
...
protected:
  LabelSizeRegionRatioOpeningImageFilter() {};
  ~LabelSizeRegionRatioOpeningImageFilter() {};

private:
  LabelSizeRegionRatioOpeningImageFilter(const Self&); //purposely not implemented
