/*=========================================================================
  ...
  Module:    $RCSfile: itkLabelRegionElongationKeepNObjectsImageFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkLabelRegionElongationKeepNObjectsImageFilter_h
#define __itkLabelRegionElongationKeepNObjectsImageFilter_h
...
/** \class LabelRegionElongationKeepNObjectsImageFilter
 * \brief Identify local maxima whose height above the baseline is greater than h.
 *
 * \ingroup ImageEnhancement  MathematicalMorphologyImageFilters
 */
template<class TInputImage>
class ITK_EXPORT LabelRegionElongationKeepNObjectsImageFilter : 
    public LabelAttributeKeepNObjectsImageFilter<TInputImage,
      ...
      typename Functor::RegionElongationLabelObjectAccessor< ShapeLabelObject< unsigned long, TInputImage::ImageDimension > > >
{
public:
  /** Standard class typedefs. */
  typedef LabelRegionElongationKeepNObjectsImageFilter Self;
  ...
  itkTypeMacro(LabelRegionElongationKeepNObjectsImageFilter, 
...
protected:
  LabelRegionElongationKeepNObjectsImageFilter() {};
  ~LabelRegionElongationKeepNObjectsImageFilter() {};

private:
  LabelRegionElongationKeepNObjectsImageFilter(const Self&); //purposely not implemented
