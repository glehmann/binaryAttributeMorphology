/*=========================================================================
  ...
  Module:    $RCSfile: itkMinimumRelabelImageFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkMinimumRelabelImageFilter_h
#define __itkMinimumRelabelImageFilter_h
...
/** \class MinimumRelabelImageFilter
 * \brief Identify local maxima whose height above the baseline is greater than h.
 *
 * \ingroup ImageEnhancement  MathematicalMorphologyImageFilters
 */
template<class TInputImage, class TFeatureImage>
class ITK_EXPORT MinimumRelabelImageFilter : 
    public AttributeRelabelImageFilter<TInputImage,
...
public:
  ...
  typedef MinimumRelabelImageFilter Self;
  typedef AttributeRelabelImageFilter<TInputImage,
      StatisticsLabelObject< unsigned long, TInputImage::ImageDimension >,
      StatisticsLabelCollectionImageFilter< LabelCollectionImage< StatisticsLabelObject< unsigned long, TInputImage::ImageDimension > >, TFeatureImage >,
      typename Functor::MinimumLabelObjectAccessor< StatisticsLabelObject< unsigned long, TInputImage::ImageDimension > > >
      Superclass;
  ...
  typedef typename Superclass::RelabelType RelabelType;
  ...
  itkTypeMacro(MinimumRelabelImageFilter, 
               LabelAttributeRelabelImageFilter);
...
protected:
  MinimumRelabelImageFilter() {};
  ~MinimumRelabelImageFilter() {};

  virtual void CustomizeInternalFilters( LabelizerType *, LabelObjectValuatorType * valuator, RelabelType *, BinarizerType* )
    {
    valuator->SetFeatureImage( this->GetFeatureImage() );
    }

private:
  MinimumRelabelImageFilter(const Self&); //purposely not implemented
