/*=========================================================================
  ...
  Module:    $RCSfile: itkSigmaRelabelImageFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkSigmaRelabelImageFilter_h
#define __itkSigmaRelabelImageFilter_h
...
public:
  ...
  typedef SigmaRelabelImageFilter Self;
  ...
  itkTypeMacro(SigmaRelabelImageFilter, 
...
private:
  SigmaRelabelImageFilter(const Self&); //purposely not implemented
