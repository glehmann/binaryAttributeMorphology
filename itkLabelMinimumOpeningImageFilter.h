/*=========================================================================
  ...
  Module:    $RCSfile: itkLabelMinimumOpeningImageFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkLabelMinimumOpeningImageFilter_h
#define __itkLabelMinimumOpeningImageFilter_h
...
public:
  ...
  typedef LabelMinimumOpeningImageFilter Self;
  ...
  itkTypeMacro(LabelMinimumOpeningImageFilter, 
...
protected:
  LabelMinimumOpeningImageFilter() {};
  ~LabelMinimumOpeningImageFilter() {};
...
private:
  LabelMinimumOpeningImageFilter(const Self&); //purposely not implemented
