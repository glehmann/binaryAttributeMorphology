...
int main(int argc, char * argv[])
{
  ...
  if( argc != 8 )
    {
    std::cerr << "usage: " << argv[0] << " input output foreground background nb reverseOrdering connectivity" << std::endl;
    // std::cerr << "  : " << std::endl;
    exit(1);
    }
  ...
  typedef itk::BinarySizeKeepNObjectsImageFilter< IType > BinaryOpeningType;
