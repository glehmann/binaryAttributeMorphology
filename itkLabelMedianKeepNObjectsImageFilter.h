/*=========================================================================
  ...
  Module:    $RCSfile: itkLabelMedianKeepNObjectsImageFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkLabelMedianKeepNObjectsImageFilter_h
#define __itkLabelMedianKeepNObjectsImageFilter_h
...
class ITK_EXPORT LabelMedianKeepNObjectsImageFilter : 
    public LabelAttributeKeepNObjectsImageFilter<TInputImage,
      ...
      typename Functor::MedianLabelObjectAccessor< StatisticsLabelObject< unsigned long, TInputImage::ImageDimension > > >
{
public:
  /** Standard class typedefs. */
  typedef LabelMedianKeepNObjectsImageFilter Self;
  ...
  itkTypeMacro(LabelMedianKeepNObjectsImageFilter, 
...
protected:
  LabelMedianKeepNObjectsImageFilter() {};
  ~LabelMedianKeepNObjectsImageFilter() {};
...
private:
  LabelMedianKeepNObjectsImageFilter(const Self&); //purposely not implemented
