/*=========================================================================
  ...
  Module:    $RCSfile: itkLabelXXXKeepNObjectsImageFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkLabelXXXKeepNObjectsImageFilter_h
#define __itkLabelXXXKeepNObjectsImageFilter_h
...
class ITK_EXPORT LabelXXXKeepNObjectsImageFilter : 
    public LabelAttributeKeepNObjectsImageFilter<TInputImage,
      ...
      typename Functor::XXXLabelObjectAccessor< StatisticsLabelObject< unsigned long, TInputImage::ImageDimension > > >
{
public:
  /** Standard class typedefs. */
  typedef LabelXXXKeepNObjectsImageFilter Self;
  ...
  itkTypeMacro(LabelXXXKeepNObjectsImageFilter, 
...
protected:
  LabelXXXKeepNObjectsImageFilter() {};
  ~LabelXXXKeepNObjectsImageFilter() {};
...
private:
  LabelXXXKeepNObjectsImageFilter(const Self&); //purposely not implemented
