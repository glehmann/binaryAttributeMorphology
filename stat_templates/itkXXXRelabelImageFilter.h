/*=========================================================================
  ...
  Module:    $RCSfile: itkXXXRelabelImageFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkXXXRelabelImageFilter_h
#define __itkXXXRelabelImageFilter_h
...
public:
  ...
  typedef XXXRelabelImageFilter Self;
  ...
  itkTypeMacro(XXXRelabelImageFilter, 
...
private:
  XXXRelabelImageFilter(const Self&); //purposely not implemented
