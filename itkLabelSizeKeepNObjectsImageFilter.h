/*=========================================================================
  ...
  Module:    $RCSfile: itkLabelSizeKeepNObjectsImageFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkLabelSizeKeepNObjectsImageFilter_h
...
public:
  ...
  typedef LabelSizeKeepNObjectsImageFilter Self;
  ...
  itkTypeMacro(LabelSizeKeepNObjectsImageFilter, 
...
protected:
  LabelSizeKeepNObjectsImageFilter() {};
  ~LabelSizeKeepNObjectsImageFilter() {};

private:
  LabelSizeKeepNObjectsImageFilter(const Self&); //purposely not implemented
