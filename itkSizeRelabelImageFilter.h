/*=========================================================================
  ...
  Module:    $RCSfile: itkSizeRelabelImageFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkSizeRelabelImageFilter_h
...
public:
  ...
  typedef SizeRelabelImageFilter Self;
  ...
  itkTypeMacro(SizeRelabelImageFilter, 
...
protected:
  SizeRelabelImageFilter() {};
  ~SizeRelabelImageFilter() {};

private:
  SizeRelabelImageFilter(const Self&); //purposely not implemented
