/*=========================================================================
  ...
  Module:    $RCSfile: itkMeanRelabelImageFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkMeanRelabelImageFilter_h
#define __itkMeanRelabelImageFilter_h
...
public:
  ...
  typedef MeanRelabelImageFilter Self;
  ...
  itkTypeMacro(MeanRelabelImageFilter, 
...
private:
  MeanRelabelImageFilter(const Self&); //purposely not implemented
