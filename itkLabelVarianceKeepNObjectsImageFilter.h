/*=========================================================================
  ...
  Module:    $RCSfile: itkLabelVarianceKeepNObjectsImageFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkLabelVarianceKeepNObjectsImageFilter_h
#define __itkLabelVarianceKeepNObjectsImageFilter_h
...
public:
  ...
  typedef LabelVarianceKeepNObjectsImageFilter Self;
  ...
  itkTypeMacro(LabelVarianceKeepNObjectsImageFilter, 
...
protected:
  LabelVarianceKeepNObjectsImageFilter() {};
  ~LabelVarianceKeepNObjectsImageFilter() {};
...
private:
  LabelVarianceKeepNObjectsImageFilter(const Self&); //purposely not implemented
