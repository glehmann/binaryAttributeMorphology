/*=========================================================================
  ...
  Module:    $RCSfile: itkBinaryRegionElongationKeepNObjectsImageFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkBinaryRegionElongationKeepNObjectsImageFilter_h
#define __itkBinaryRegionElongationKeepNObjectsImageFilter_h
...
/** \class BinaryRegionElongationKeepNObjectsImageFilter
 * \brief Identify local maxima whose height above the baseline is greater than h.
 *
 * \ingroup ImageEnhancement  MathematicalMorphologyImageFilters
 */
template<class TInputImage>
class ITK_EXPORT BinaryRegionElongationKeepNObjectsImageFilter : 
...
public:
  ...
  typedef BinaryRegionElongationKeepNObjectsImageFilter Self;
  ...
  itkTypeMacro(BinaryRegionElongationKeepNObjectsImageFilter, 
...
protected:
  BinaryRegionElongationKeepNObjectsImageFilter() {};
  ~BinaryRegionElongationKeepNObjectsImageFilter() {};

private:
  BinaryRegionElongationKeepNObjectsImageFilter(const Self&); //purposely not implemented
