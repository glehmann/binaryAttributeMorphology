/*=========================================================================
  ...
  Module:    $RCSfile: itkSizeRegionRatioRelabelImageFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkSizeRegionRatioRelabelImageFilter_h
#define __itkSizeRegionRatioRelabelImageFilter_h
...
public:
  ...
  typedef SizeRegionRatioRelabelImageFilter Self;
  ...
  itkTypeMacro(SizeRegionRatioRelabelImageFilter, 
...
protected:
  SizeRegionRatioRelabelImageFilter() {};
  ~SizeRegionRatioRelabelImageFilter() {};

private:
  SizeRegionRatioRelabelImageFilter(const Self&); //purposely not implemented
