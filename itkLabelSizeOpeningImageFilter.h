/*=========================================================================
  ...
  Module:    $RCSfile: itkLabelSizeOpeningImageFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkLabelSizeOpeningImageFilter_h
...
public:
  ...
  typedef LabelSizeOpeningImageFilter Self;
  ...
  itkTypeMacro(LabelSizeOpeningImageFilter, 
...
protected:
  LabelSizeOpeningImageFilter() {};
  ~LabelSizeOpeningImageFilter() {};

private:
  LabelSizeOpeningImageFilter(const Self&); //purposely not implemented
