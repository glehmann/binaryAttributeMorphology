/*=========================================================================
  ...
  Module:    $RCSfile: itkBinarySizeRegionRatioKeepNObjectsImageFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkBinarySizeRegionRatioKeepNObjectsImageFilter_h
#define __itkBinarySizeRegionRatioKeepNObjectsImageFilter_h
...
/** \class BinarySizeRegionRatioKeepNObjectsImageFilter
 * \brief Identify local maxima whose height above the baseline is greater than h.
 *
 * \ingroup ImageEnhancement  MathematicalMorphologyImageFilters
 */
template<class TInputImage>
class ITK_EXPORT BinarySizeRegionRatioKeepNObjectsImageFilter : 
...
public:
  ...
  typedef BinarySizeRegionRatioKeepNObjectsImageFilter Self;
  ...
  itkTypeMacro(BinarySizeRegionRatioKeepNObjectsImageFilter, 
...
protected:
  BinarySizeRegionRatioKeepNObjectsImageFilter() {};
  ~BinarySizeRegionRatioKeepNObjectsImageFilter() {};

private:
  BinarySizeRegionRatioKeepNObjectsImageFilter(const Self&); //purposely not implemented
