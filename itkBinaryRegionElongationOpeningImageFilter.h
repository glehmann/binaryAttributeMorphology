/*=========================================================================
  ...
  Module:    $RCSfile: itkBinaryRegionElongationOpeningImageFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkBinaryRegionElongationOpeningImageFilter_h
#define __itkBinaryRegionElongationOpeningImageFilter_h
...
/** \class BinaryRegionElongationOpeningImageFilter
 * \brief Identify local maxima whose height above the baseline is greater than h.
 *
 * \ingroup ImageEnhancement  MathematicalMorphologyImageFilters
 */
template<class TInputImage>
class ITK_EXPORT BinaryRegionElongationOpeningImageFilter : 
...
public:
  ...
  typedef BinaryRegionElongationOpeningImageFilter Self;
  ...
  itkTypeMacro(BinaryRegionElongationOpeningImageFilter, 
...
protected:
  BinaryRegionElongationOpeningImageFilter() {};
  ~BinaryRegionElongationOpeningImageFilter() {};

private:
  BinaryRegionElongationOpeningImageFilter(const Self&); //purposely not implemented
