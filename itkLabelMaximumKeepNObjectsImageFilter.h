/*=========================================================================
  ...
  Module:    $RCSfile: itkLabelMaximumKeepNObjectsImageFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkLabelMaximumKeepNObjectsImageFilter_h
#define __itkLabelMaximumKeepNObjectsImageFilter_h
...
/** \class LabelMaximumKeepNObjectsImageFilter
 * \brief Identify local maxima whose height above the baseline is greater than h.
 *
 * \ingroup ImageEnhancement  MathematicalMorphologyImageFilters
 */
template<class TInputImage, class TFeatureImage>
class ITK_EXPORT LabelMaximumKeepNObjectsImageFilter : 
    public LabelAttributeKeepNObjectsImageFilter<TInputImage,
      ...
      typename Functor::MaximumLabelObjectAccessor< StatisticsLabelObject< unsigned long, TInputImage::ImageDimension > > >
{
public:
  /** Standard class typedefs. */
  typedef LabelMaximumKeepNObjectsImageFilter Self;
  typedef LabelAttributeKeepNObjectsImageFilter<TInputImage,
      StatisticsLabelObject< unsigned long, TInputImage::ImageDimension >,
      StatisticsLabelCollectionImageFilter< LabelCollectionImage< StatisticsLabelObject< unsigned long, TInputImage::ImageDimension > >, TFeatureImage >,
      typename Functor::MaximumLabelObjectAccessor< StatisticsLabelObject< unsigned long, TInputImage::ImageDimension > > >
      Superclass;
  ...
  itkTypeMacro(LabelMaximumKeepNObjectsImageFilter, 
...
protected:
  LabelMaximumKeepNObjectsImageFilter() {};
  ~LabelMaximumKeepNObjectsImageFilter() {};

  virtual void CustomizeInternalFilters( LabelizerType *, LabelObjectValuatorType * valuator, KeepNObjectsType *, BinarizerType* )
    {
    valuator->SetFeatureImage( this->GetFeatureImage() );
    }

private:
  LabelMaximumKeepNObjectsImageFilter(const Self&); //purposely not implemented
