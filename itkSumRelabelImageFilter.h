/*=========================================================================
  ...
  Module:    $RCSfile: itkSumRelabelImageFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkSumRelabelImageFilter_h
#define __itkSumRelabelImageFilter_h
...
public:
  ...
  typedef SumRelabelImageFilter Self;
  ...
  itkTypeMacro(SumRelabelImageFilter, 
...
private:
  SumRelabelImageFilter(const Self&); //purposely not implemented
