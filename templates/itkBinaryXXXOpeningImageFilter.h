/*=========================================================================
  ...
  Module:    $RCSfile: itkBinaryXXXOpeningImageFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkBinaryXXXOpeningImageFilter_h
#define __itkBinaryXXXOpeningImageFilter_h
...
public:
  ...
  typedef BinaryXXXOpeningImageFilter Self;
  ...
  itkTypeMacro(BinaryXXXOpeningImageFilter, 
...
protected:
  BinaryXXXOpeningImageFilter() {};
  ~BinaryXXXOpeningImageFilter() {};

private:
  BinaryXXXOpeningImageFilter(const Self&); //purposely not implemented
