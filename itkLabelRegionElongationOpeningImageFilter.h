/*=========================================================================
  ...
  Module:    $RCSfile: itkLabelRegionElongationOpeningImageFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkLabelRegionElongationOpeningImageFilter_h
#define __itkLabelRegionElongationOpeningImageFilter_h
...
/** \class LabelRegionElongationOpeningImageFilter
 * \brief Identify local maxima whose height above the baseline is greater than h.
 *
 * \ingroup ImageEnhancement  MathematicalMorphologyImageFilters
 */
template<class TInputImage>
class ITK_EXPORT LabelRegionElongationOpeningImageFilter : 
...
public:
  ...
  typedef LabelRegionElongationOpeningImageFilter Self;
  ...
  itkTypeMacro(LabelRegionElongationOpeningImageFilter, 
...
protected:
  LabelRegionElongationOpeningImageFilter() {};
  ~LabelRegionElongationOpeningImageFilter() {};

private:
  LabelRegionElongationOpeningImageFilter(const Self&); //purposely not implemented
