/*=========================================================================
  ...
  Module:    $RCSfile: itkLabelMeanKeepNObjectsImageFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkLabelMeanKeepNObjectsImageFilter_h
#define __itkLabelMeanKeepNObjectsImageFilter_h
...
class ITK_EXPORT LabelMeanKeepNObjectsImageFilter : 
    public LabelAttributeKeepNObjectsImageFilter<TInputImage,
      ...
      typename Functor::MeanLabelObjectAccessor< StatisticsLabelObject< unsigned long, TInputImage::ImageDimension > > >
{
public:
  /** Standard class typedefs. */
  typedef LabelMeanKeepNObjectsImageFilter Self;
  ...
  itkTypeMacro(LabelMeanKeepNObjectsImageFilter, 
...
protected:
  LabelMeanKeepNObjectsImageFilter() {};
  ~LabelMeanKeepNObjectsImageFilter() {};
...
private:
  LabelMeanKeepNObjectsImageFilter(const Self&); //purposely not implemented
