/*=========================================================================
  ...
  Module:    $RCSfile: itkLabelSigmaKeepNObjectsImageFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkLabelSigmaKeepNObjectsImageFilter_h
#define __itkLabelSigmaKeepNObjectsImageFilter_h
...
class ITK_EXPORT LabelSigmaKeepNObjectsImageFilter : 
    public LabelAttributeKeepNObjectsImageFilter<TInputImage,
      ...
      typename Functor::SigmaLabelObjectAccessor< StatisticsLabelObject< unsigned long, TInputImage::ImageDimension > > >
{
public:
  /** Standard class typedefs. */
  typedef LabelSigmaKeepNObjectsImageFilter Self;
  ...
  itkTypeMacro(LabelSigmaKeepNObjectsImageFilter, 
...
protected:
  LabelSigmaKeepNObjectsImageFilter() {};
  ~LabelSigmaKeepNObjectsImageFilter() {};
...
private:
  LabelSigmaKeepNObjectsImageFilter(const Self&); //purposely not implemented
